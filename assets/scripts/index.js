...
$(document).ready(function() {
  ...
  $.get('/news/wp-content/themes/nu-news-002/year-in-photos-2016/yip.csv', function (data) {
    ...
    var heading = function() {
      ...
      ret += '<h5>University photographers Matthew Modoono and Adam Glanzman were there to capture all the monumental and memorable moments of our community in 2016.</h5>'
      ret += '</div>'
      ret +='</div>'
